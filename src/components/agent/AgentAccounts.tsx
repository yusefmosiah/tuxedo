  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        💡 <strong>Agent-First Architecture:</strong> The AI agent manages these accounts autonomously.
        All transactions are handled by the agent without user intervention.
      </div>
    </div>
  );
};