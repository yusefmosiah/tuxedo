...
export const DeFindexVaultsDashboard: React.FC = () => {
  ...
  const handleDiscoverVaults = () => {
    const query =
      "Show me available DeFindex vaults on testnet with their current APY rates";
    sendMessage(query);
  };
    ...
    <div style={{ maxWidth: "1400px", margin: "0 auto", padding: "20px" }}>
      ...
      {selectedVault && (
        ...
        >
          ...
          >
            <strong>💡 How it works:</strong> The AI assistant will provide
            manual payment instructions. You'll send XLM directly to the vault
            contract address, and it will automatically recognize the payment as
            a deposit. No API dependencies - just pure Stellar blockchain
            transactions!
          </div>
        </div>
      )}
