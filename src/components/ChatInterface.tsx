  ...
  useEffect(() => {
    const checkHealth = async () => {
      try {
        ...
        console.log(
          "🔍 Health check - stellar_tools_ready:",
          health.stellar_tools_ready,
        );
        console.log(
          "🔍 Health check - live_summary_ready:",
          health.live_summary_ready,
        );
        ...
        if (health.status === "healthy" && health.stellar_tools_ready) {
          ...
          console.log("⚠️ Health check failed conditions:", {
            ...
            both_conditions:
              health.status === "healthy" && health.stellar_tools_ready,
          });
        ...
        {messages.length === 0 && (
          <div style={{ textAlign: "center", marginTop: "40px" }}>
            ...
            {agent.activeAccount && (
              ...
              >
                🤖 Agent Account: {agent.activeAccount.slice(0, 8)}...
                {agent.activeAccount.slice(-4)}
              </Text>
            )}
        ...
        <div style={{ display: "flex", gap: "8px" }}>
          <textarea
            ...
            style={{
              ...
              minHeight: "44px",
              backgroundColor:
                apiStatus === "disconnected" ? "#f8f9fa" : "#fff",
