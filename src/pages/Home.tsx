    ...
    <Layout.Inset>
      ...
      <div style={{ marginTop: "20px", display: "flex", gap: "10px" }}>
        <Button
          variant="primary"
          size="md"
          onClick={() => (window.location.href = "/discover-pools")}
        >
          🔍 Discover All Pools & Tokens
        </Button>
      </div>

      <hr style={{ margin: "60px 0", border: "none", borderTop: "2px solid #ddd" }} />

      <Text as="h1" size="xl">
        Blend Protocol Integration
      </Text>
      <Text as="p" size="md">
        This app is configured to interact with Blend Protocol on Stellar Testnet.
      </Text>
